...
<div id="appCapsule">
	...
	<div class="section mt-3">
		<div class="profile-head">
			<div class="avatar">
				<img src="http://<?= $_SERVER['HTTP_HOST'] ?>/kepegawaian/assets/images/foto_karyawan/<?= $karyawan['foto'] ?>" alt="avatar" class="imaged w100 rounded">
			</div>
			<div class="in">
				<h3 class="name"><?= $karyawan['nama_ktp'] ?></h3>
				<h5 class="subtext"><?= $karyawan['bagian'] ?></h5>
				<h5 class="subtext"><?= $karyawan['jabatan'] ?></h5>
				<div class="chip chip-media mt-1 bg-secondary">
					<a href="<?= base_url() ?>profil/edit_biodata" class="text-decoration-none  text-light">
		...
		<div class="tab-content">
			...
			<div class="tab-pane fade" id="friends" role="tabpanel">
				<ul class="listview image-listview flush transparent pt-1">
					...
					?>
							<li>
								<a href="<?= base_url() ?>karyawan/profil_karyawan/<?= $fr['nik'] ?>" class="item">
									<img src="http://<?= $_SERVER['HTTP_HOST'] ?>/kepegawaian/assets/images/foto_karyawan/<?= $fr['foto'] ?>" alt="image" class="image">
									<div class="in">
										<div>
											<?= $fr['nama_ktp'] ?>
										</div>
