...
<body class="bg-white">
	...
	<div id="appCapsule">
		...
		<div class="error-page">
			<img src="<?= base_url() ?>assets/img/under-contruction.png" alt="alt" class="imaged square w200 mb-5">
			<h1 class="title">Sorry.. <br> this menu is under contruction.</h1>
			<div class="text mb-5">
				This menu is not ready. <br> We are working on it.
			</div>
