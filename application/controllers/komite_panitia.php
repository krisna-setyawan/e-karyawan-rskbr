...
class Komite_panitia extends CI_Controller
{
	...
	public function getAnggota()
	{
		...
		$q = "SELECT new_anggota_komite.*, new_dt_karyawan.foto FROM new_anggota_komite JOIN new_dt_karyawan 
			ON new_anggota_komite.id_karyawan = new_dt_karyawan.id WHERE new_anggota_komite.id_komite = $id_komite";
		$karyawan = $this->db->query($q)->result();
